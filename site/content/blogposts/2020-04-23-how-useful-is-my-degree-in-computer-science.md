...
The most logical choice would have been to go to the Vrije Universiteit Brussel (Free University of Brussels), or in short: VUB.
It was very accessible by train, my friends from school were continuing their studies at the VUB and the initial impression that I had online was quite good.
...
I felt so much passion when they were talking about all the courses they were given.
...
## What were the contents of my Bachelors?

<g-image alt="Structure and Interpretation of Computer Programs book cover" src="~/assets/img/how-useful-is-my-degree-in-computer-science/structure-and-interpretation-of-computer-programs.jpg" position="center" fit="contain" width="250" align="left" />
In September of that year, I started my first year in the bachelor program called Computer Sciences.
...
While in my first year I had courses like "Algorithms and Datastructures", I had part 2 in my second year.
...
During my second and third year of my Bachelors, the courses were pretty diverse.
In courses like Computer Systems, I learned more about the internals of a computer.
Like how are CPU's internally structured, right down to how AND-ports, OR-ports and such are wired.
...
My Bachelors could be considered a preparation for my Masters.
One of the main reasons for this was that my Bachelors was more generic.
...
But not doing a Masters would not have felt as having done enough for me.

## What were the contents of my Masters?

In my Masters I had more freedom in the courses that I was allowed to take.
...
I would also have to end my two years Master with a thesis worth 30 credits.
...
In courses like Web Engineering I learned about the history of browsers and had to create a website with a framework like Drupal.
In other courses I learned to work with database and more advanced information systems like working with ontologies and querying them with SPARQL queries.
All in all there was a huge portion of practical excercises in my Masters.
There was also more theoretical stuff like User Interface Design where I learned the basics of good UI design.

From all the courses I had during my Masters, some directly benefited me in the early parts of my career when I was a fullstack developer.
Others never benefited me or were eventually transposable to some other technologies.
All in all, I would say that the contents of my Masters were too theoretical for what I would be doing for the early parts of my career.
...
### I've learned many languages that I never directly use

During my education, I've learned numerous languages.
A quick summary: Scheme, C, C++, C#, Java, JavaScript, Smalltalk, Prolog, Assembly, R, Ruby; research languages like Ambienttalk and Pico; scripting, query and markup languages like SQL, HTML, CSS and XML.
Out of these 17 languages, I have used 7 in my career: C#, Java, JavaScript, SQL, HTML, CSS and XML.
...
Certain langauge features like closures and scoping rules are stuff that I can translate from my Scheme knowledge in my Bachelors.
...
Certain programming concepts such as interfaces, generics, classes and more were explained in some way or form theoretically.
...
### A lot of courses gave me background knowledge that I don't apply in my current job
...
## So... was it useful to get a degree in Computer Science? Would I do it again?
...
I've learned how to be a developer that can easily pick up something new and play around with it, that has a deeper understanding of how stuff works.
